...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.Register(c => c.Resolve<IHttpContextAccessor>().HttpContext)
                .As<HttpContext>()
                .InstancePerLifetimeScope();
            builder.Register(c => c.Resolve<HttpContext>().Request)
                .As<Microsoft.AspNetCore.Http.HttpRequest>()
                .InstancePerLifetimeScope();
            builder.Register(c => c.Resolve<HttpContext>().Response)
                .As<HttpResponse>()
                .InstancePerLifetimeScope();
            // HttpContext.Server removed in ASP.NET Core - use IWebHostEnvironment instead
            ...
            //controllers - removed RegisterControllers (use ASP.NET Core DI)
            ...
            //picture service
            // Azure BLOB support removed - using standard PictureService

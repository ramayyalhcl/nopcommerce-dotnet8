...
namespace Nop.Web.Framework.UI
{
    ...
    public static class LayoutExtensions
    {
        ...
        /// <returns>Generated string</returns>
        public static IHtmlContent NopScripts(this IHtmlHelper html, IUrlHelper IUrlHelper, 
        ...
        /// <param name="bundleFiles">A value indicating whether to bundle script elements</param>
        /// <returns>Generated string</returns>
        public static IHtmlContent NopCssFiles(this IHtmlHelper html, IUrlHelper IUrlHelper,
            ResourceLocation location, bool? bundleFiles = null)
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();

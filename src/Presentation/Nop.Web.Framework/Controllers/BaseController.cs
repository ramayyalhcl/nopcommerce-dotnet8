...
// using Nop.Web.Framework.Kendoui; - Removed
...
namespace Nop.Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        {
            // Simplified for ASP.NET Core - needs reimplementation with IViewEngine

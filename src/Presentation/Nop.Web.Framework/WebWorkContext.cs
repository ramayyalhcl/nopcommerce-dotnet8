...
namespace Nop.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        protected virtual void SetCustomerCookie(Guid customerGuid)
        {
            if (_httpContext != null && _httpContext.Response != null)
            {
                ...
                if (customerGuid == Guid.Empty)
                {
                    ...
                    _httpContext.Response.Cookies.Append(CustomerCookieName, string.Empty, cookieOptions);
                }
                else
                {
                    int cookieExpires = 24*365; //TODO make configurable
                    cookieOptions.Expires = DateTime.Now.AddHours(cookieExpires);
                    _httpContext.Response.Cookies.Append(CustomerCookieName, customerGuid.ToString(), cookieOptions);
                }
            }
        }
        ...
        protected virtual Language GetLanguageFromUrl()
        {
            ...
            string virtualPath = _httpContext.Request.Path.Value;
            string applicationPath = _httpContext.Request.PathBase.Value ?? "/";
        ...
        protected virtual Language GetLanguageFromBrowserSettings()
        {
            ...
            var acceptLanguage = _httpContext.Request.Headers["Accept-Language"].ToString();

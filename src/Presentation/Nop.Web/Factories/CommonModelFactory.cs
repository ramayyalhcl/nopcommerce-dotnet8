...
namespace Nop.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual FaviconModel PrepareFaviconModel()
        {
            ...
            var localFaviconPath = System.IO.Path.Combine(_httpContext.Request/* .PhysicalApplicationPath - use IWebHostEnvironment.ContentRootPath */ .PathBase /* TODO: Use IWebHostEnvironment */, faviconFileName);
            if (!System.IO.File.Exists(localFaviconPath))
            {
                //try loading a generic favicon
                faviconFileName = "favicon.ico";
                localFaviconPath = System.IO.Path.Combine(_httpContext.Request/* .PhysicalApplicationPath - use IWebHostEnvironment.ContentRootPath */ .PathBase /* TODO: Use IWebHostEnvironment */, faviconFileName);
                if (!System.IO.File.Exists(localFaviconPath))
                {
                    return model;
                }

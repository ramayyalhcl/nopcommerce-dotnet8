    ...
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual SearchModel PrepareSearchModel(SearchModel model, CatalogPagingFilteringModel command)
        {
            ...
            try
            {
                ...
                isSearchTermSpecified = !string.IsNullOrEmpty(_httpContext.Request.Query["q"].ToString());
            }
            catch
            {
                ...
                //although we // [ValidateInput] - removed in .NET 8 attribute here we try to access "Request.Params" directly

...
namespace Nop.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        public virtual ActionResult PageNotFound()
        {
            ...
            // this.Response.TrySkipIisCustomErrors - removed in ASP.NET Core
        ...
        //logo
        // [ChildActionOnly] - removed, use ViewComponent
        ...
        public virtual ActionResult RobotsTextFile()
        {
            ...
            // Response.Write() removed in ASP.NET Core - use Content() result

...
namespace Nop.Web.Controllers
{
    ...
    public partial class PrivateMessagesController : BasePublicController
    {
        ...
        [PublicAntiForgery]
        public virtual ActionResult DeleteInboxPM(IFormCollection IFormCollection)
        {
        ...
        [PublicAntiForgery]
        public virtual ActionResult MarkUnread(IFormCollection IFormCollection)
        {
            foreach (var key in IFormCollection.Keys)
            {
                var value = IFormCollection[key];
        ...
        [PublicAntiForgery]
        public virtual ActionResult DeleteSentPM(IFormCollection IFormCollection)
        {
            foreach (var key in IFormCollection.Keys)
            {
                var value = IFormCollection[key];

...
namespace Nop.Web.Models.Common
{
    public partial class PagerModel
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to show object /* Pager removed */ items
        /// </summary>
        ...
        public string FirstButtonText
        {
            get
            {
                return (!string.IsNullOrEmpty(firstButtonText)) ?
                    firstButtonText :
                    _localizationService.GetResource("object /* Pager removed */.First");
            }
            set
            {
        ...
        public string LastButtonText
        {
            get
            {
                return (!string.IsNullOrEmpty(lastButtonText)) ?
                    lastButtonText :
                    _localizationService.GetResource("object /* Pager removed */.Last");
            }
            set
            {
        ...
        public string NextButtonText
        {
            get
            {
                return (!string.IsNullOrEmpty(nextButtonText)) ?
                    nextButtonText :
                    _localizationService.GetResource("object /* Pager removed */.Next");
            }
            set
            {
        ...
        public string PreviousButtonText
        {
            get
            {
                return (!string.IsNullOrEmpty(previousButtonText)) ?
                    previousButtonText :
                    _localizationService.GetResource("object /* Pager removed */.Previous");
            }
            set
            {
        ...
        public string CurrentPageText
        {
            get
            {
                return (!string.IsNullOrEmpty(currentPageText)) ?
                    currentPageText :
                    _localizationService.GetResource("object /* Pager removed */.CurrentPage");
            }
            set
            {

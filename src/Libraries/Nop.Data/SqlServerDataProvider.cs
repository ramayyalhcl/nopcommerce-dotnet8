...
namespace Nop.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            // SqlConnectionFactory and Database.DefaultConnectionFactory don't exist in EF Core
            // EF Core uses connection strings directly in DbContextOptions
            // No-op for EF Core
        }
        ...
        {
            // Database initializers don't exist in EF Core
            // Use migrations or Database.EnsureCreated() instead
            // No-op for EF Core

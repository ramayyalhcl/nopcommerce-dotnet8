...
// using System.Drawing; - Replaced with ImageResizer/SixLabors.ImageSharp
using System.IO;
using System.Linq;
...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        /// <returns></returns>
        protected virtual (int Width, int Height) CalculateDimensions((int Width, int Height) originalSize, int targetSize,
            ...
            string storeLocation = null)
        {
            ...
            else
            {
                ...
                {
                    // TODO: Replace Bitmap with SixLabors.ImageSharp for image processing
                    // System.Drawing.Bitmap not recommended for .NET 8
            ...
            using (var mutex = new Mutex(false, thumbFileName))
            {
                ...
                { 
                    ...
                    if (!GeneratedThumbExists(thumbFilePath, thumbFileName))
                    {
                        ...
                        if (targetSize != 0)
                        {
                            // TODO: Implement using SixLabors.ImageSharp
                            // System.Drawing.Bitmap not recommended for .NET 8
                            // For now, use original image without resizing

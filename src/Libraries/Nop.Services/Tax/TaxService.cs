...
namespace Nop.Services.Tax
{
    ...
    public partial class TaxService : ITaxService
    {
            ...
            out string name, out string address, out Exception exception)
        {
            ...
            // EU VAT check service commented out - ASMX not supported in .NET 8
            // TODO: Implement using HttpClient to call EU VIES service
            // Endpoint: http://ec.europa.eu/taxation_customs/vies/services/checkVatService
            exception = new NotImplementedException("EU VAT validation service needs migration to HttpClient");
            name = string.Empty;
            address = string.Empty;
            return VatNumberStatus.Unknown;

...
namespace Nop.Services.Seo
{
    ...
    public partial class SitemapGenerator : ISitemapGenerator
    {
        ...
        protected virtual IList<SitemapUrl> GenerateUrls(object urlHelper)
        {
            var sitemapUrls = new List<SitemapUrl>();
            
            // TODO: UrlHelper type will come from Web.Framework (ASP.NET Core IUrlHelper)
            // For now, return empty list - this will be properly implemented when web tier is migrated
            return sitemapUrls;
            
            /* OLD CODE - needs UrlHelper from System.Web.Mvc
            //home page
        ...
        protected virtual IEnumerable<SitemapUrl> GetCategoryUrls(object urlHelper, int parentCategoryId)
        {
            // TODO: Implement using ASP.NET Core IUrlHelper
        ...
        /// <param name="urlHelper">URL helper</param>
        /// <returns>Collection of sitemap URLs</returns>
        protected virtual IEnumerable<SitemapUrl> GetManufacturerUrls(object urlHelper)
        {
            // TODO: Implement when urlHelper is typed as IUrlHelper from ASP.NET Core
            return new List<SitemapUrl>();
        }
        ...
        /// <param name="urlHelper">URL helper</param>
        /// <returns>Collection of sitemap URLs</returns>
        protected virtual IEnumerable<SitemapUrl> GetProductUrls(object urlHelper)
        {
            // TODO: Implement when urlHelper is typed as IUrlHelper from ASP.NET Core
            return new List<SitemapUrl>();
        }
        ...
        /// <param name="urlHelper">URL helper</param>
        /// <returns>Collection of sitemap URLs</returns>
        protected virtual IEnumerable<SitemapUrl> GetTopicUrls(object urlHelper)
        {
            // TODO: Implement when urlHelper is typed as IUrlHelper from ASP.NET Core
            return new List<SitemapUrl>();
        }
        ...
        protected virtual void WriteSitemapIndex(object urlHelper, Stream stream, int sitemapNumber)
        {
            using (var writer = new XmlTextWriter(stream, Encoding.UTF8))
            {
                ...
                {
                    // TODO: Implement URL generation using ASP.NET Core IUrlHelper
                    var url = $"{GetHttpProtocol()}://localhost/sitemap-{id}.xml";
        ...
        protected virtual void WriteSitemap(object urlHelper, Stream stream, IList<SitemapUrl> sitemapUrls)
        {
            using (var writer = new XmlTextWriter(stream, Encoding.UTF8))
            {
                writer.Formatting = Formatting.Indented;
        ...
        public virtual string Generate(object urlHelper, int? id)
        {
        ...
        public virtual void Generate(object urlHelper, Stream stream, int? id)
        {

...
using Microsoft.Data.SqlClient; // Updated for .NET 8
using System.IO;
using System.Linq;
...
namespace Nop.Services.Common
{
    ...
    public partial class MaintenanceService : IMaintenanceService
    {
        ...
        // HttpContextBase removed - not available in .NET 8
        // TODO: Use IHttpContextAccessor if HTTP context access needed
            ...
            CommonSettings commonSettings)
        {
            ...
            // this._httpContext = httpContext; - Removed
        }
        ...
        {
            // TODO: Get app path from IWebHelper or IHostingEnvironment
            // For now, use relative path
            return "Administration\\db_backups\\";
        }
        ...
        public virtual int? GetTableIdent<T>() where T: BaseEntity
        {
            if (_commonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
            {
                ...
                // SqlQuery removed in EF Core - use ExecuteSqlRaw or FromSqlRaw
                // For now, return 0 - TODO: Implement using DbContext.Database.ExecuteSqlRaw
                return 0;
            }

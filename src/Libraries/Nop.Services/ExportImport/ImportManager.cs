...
// using System.Web.WebPages; - Removed for .NET 8
using Nop.Core;
using Nop.Core.Data;
...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ImportManager : IImportManager
    {
        ...
        {
            // MimeMapping from System.Web not available in .NET 8
            // TODO: Use MimeTypes class or file extension mapping
            ...
            var mimeType = extension switch
            {
                ...
                _ => MimeTypes.ApplicationOctetStream
            };

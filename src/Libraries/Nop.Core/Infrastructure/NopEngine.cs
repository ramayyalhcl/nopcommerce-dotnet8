...
namespace Nop.Core.Infrastructure
{
    ...
    public class NopEngine : IEngine
    {
        ...
        protected virtual void RegisterDependencies(NopConfig config)
        {
            ...
            // DependencyResolver is ASP.NET MVC 5 specific, not needed in ASP.NET Core
            // ASP.NET Core uses built-in DI container or integrates Autofac differently
            // TODO: Update for ASP.NET Core DI integration in Startup.cs

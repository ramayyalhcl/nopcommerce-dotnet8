...
namespace Nop.Core.Infrastructure
{
    ...
    public class WebAppTypeFinder : AppDomainTypeFinder
    {
        ...
        {
            // HostingEnvironment and HttpRuntime don't exist in ASP.NET Core
            // In ASP.NET Core, use IWebHostEnvironment.ContentRootPath
            // TODO: Inject IWebHostEnvironment and use proper path resolution
            
            //For now, use base directory (works for both hosted and unit tests)

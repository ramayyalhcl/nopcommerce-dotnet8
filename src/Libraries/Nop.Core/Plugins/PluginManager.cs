...
namespace Nop.Core.Plugins
{
    ...
    public class PluginManager
    {
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            ...
            // Trust levels don't exist in ASP.NET Core - always use full trust approach
            // ASP.NET Core doesn't have CAS (Code Access Security)
            ...
            //use standard plugin loading (equivalent to full trust)
            var shadowCopyPlugFolder = Directory.CreateDirectory(_shadowCopyFolder.FullName);
            shadowCopiedPlug = InitializeFullTrust(plug, shadowCopyPlugFolder);
            
            /* OLD MEDIUM TRUST CODE - Not needed in ASP.NET Core
            ...
            */
            ...
            // BuildManager doesn't exist in ASP.NET Core
            // ASP.NET Core uses different plugin loading mechanism (Assembly.LoadFrom, AssemblyLoadContext)
            // TODO: Update plugin loading for ASP.NET Core
